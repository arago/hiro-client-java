 ...
 */
public abstract class AbstractAuthenticatedAPIHandler extends AbstractAPIHandler implements AuthenticatedAPIHandler {

    final static Logger log = LoggerFactory.getLogger(AbstractAuthenticatedAPIHandler.class);
    ...
    public static abstract class Conf<T extends Conf<T>> {
        ...
        public abstract AbstractAuthenticatedAPIHandler build();
    }
